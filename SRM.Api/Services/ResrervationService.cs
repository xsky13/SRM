...
{
    internal class ResrervationService(IReservationRespository reservationRespository) : IReservationService 
    {
        public async Task<Result<ReservationListingDto>> GetAll() {
            var reservations = await reservationRespository.GetAll();
